    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           dateOfPurchase = DateTime.Now.AddDays(2);
            ...
            //the breads is new - it expires after 3 days
           // DateTime expireDate = dateOfPurchase.Date.AddDays(+3);
            Food food1 = new Food("Breads", "Zemel", 1.25M, new DateTime(2021, 10, 28));
            ...
            Appliance app1 = new Appliance("laptop", "BrandL", 2345.67M, "ModelL", new DateTime(2021, 03, 03), "1.125 kg");
